<?php
/*
Plugin Name: MP Product Search
Plugin URI: http://www.don-benjamin.co.uk/wordpress-plugins/wp-custom-search
Description: Allows admin to build custom search form.  Allows the site admin to configure multiple html inputs for different fields including custom fields. This is a modified version of <a href="http://www.don-benjamin.co.uk/">Don Benjamin</a>'s work.
Version: 0.3.16
Author: Matt Say
Author URI: http://www.shailan.com
...
<?php
		...
		function getRootURL(){
			return WP_CONTENT_URL .'/themes/marketplace/plugins/wp-custom-fields-search/';
		}
...
//						"NotEqualComparison" =>__( "Not Equal To",'wp-custom-fields-search'),
		...
		function plugin_menu(){
			//add_options_page('MP Product Search Fields','WP Custom Fields Search',8,__FILE__,array(&$this,'presets_form'));
			add_submenu_page('mp-theme-settings', __('MP Product Search Fields', MSMP_DOMAIN), __('Search Fields', MSMP_DOMAIN), 'edit_themes', 'mp-search-fields',  array(&$this,'presets_form'));
		}
		function getPresets(){
			$presets = array();
