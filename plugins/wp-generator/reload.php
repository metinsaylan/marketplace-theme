...
<div class='eHelp' align='left'>
	...
	<table>
	  ...
	  <tr><td><b>Values:</b></td><td><input type='text' name='<?php echo $rs['position']; ?>_values' class='widefat' style='width:400px;' id='<?php echo $rs['position']; ?>_values' value="<?php echo htmlspecialchars($rs['values'], ENT_QUOTES, 'UTF-8', false ); ?>" ></td></tr>
