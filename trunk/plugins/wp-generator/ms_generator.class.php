	...
	class wpGenerator {
	 ...
	 var $wpCompat;
		...
		function makeField( $name, $default ='', $values='', $req=0, $type='text' ) {
			...
			if($req){ $out .= '<span class="required" style="color:#ff0000;">*</span>'; };
